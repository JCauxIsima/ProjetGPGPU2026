...
#include "main_Ex2_DCT_Inverse.cpp"
#include "JPEG_Encoder_code_source_2.cpp"
#include "JPEG_Decoder_code_source_3.cpp"
...
int main(int argc,char **argv)
{
  ...
  const char
    *input_f = cimg_option("-i","res/kingfischer.bmp","Image d'entrée"),
    *output_f = cimg_option("-o",(char*)0,"Image de sortie");
  float quality = cimg_option("-q", 10.0,"Facteur de qualité");
